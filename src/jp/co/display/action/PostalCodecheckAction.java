...
public class PostalCodecheckAction extends LogicBasic{
	/**
	 * 
	 */
	...
	*  @return
	*/
	public String postalCodecheckAction() throws Exception{
		EmployeeInfoManageService employeeInfoManageService=new EmployeeInfoManageService();
		employeePojo=employeeInfoManageService.postalCodecheck(employeeBean);	
		return "success";
	}
}